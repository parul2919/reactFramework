...
import styles from "./TechListing.style";
    ...
    <section className={`techStack ${className}`}>
      <div className="techStack-list">
        ...
        <ul>
          ...
          <li>
            <a href="https://momentjscom.readthedocs.io/en/latest/moment/04-displaying/01-format/">
              Moment.js -
            </a>
            Moment JS allows displaying of date as per localization and in human
            readable format.
          </li>
          <li>
        ...
        <p>
          Need to put <b>app.yml</b> file with defined configurations such as :
          Node dependency, Service name and hendlers like build files etc
        </p>
...
export default styled(TechListing)`
  ${styles}
`;
